...
import {
  ...
  Crosshair, BarChart2, Zap, Flame, Target, X, Wallet, ShoppingCart
} from 'lucide-react'
import {
    ...
    <div className="group relative overflow-hidden rounded-xl border border-zinc-700/40 hover:border-orange-500/40 transition-all duration-500 h-full flex flex-col bg-gradient-to-br from-zinc-900 to-black shadow-lg hover:shadow-2xl hover:shadow-orange-500/10">
      ...
      <div className="flex-1 flex flex-col p-4 relative z-10">
        <div className="mb-3">
          ...
          <h3 className="text-xl font-black italic uppercase text-white">{last}</h3>
          <div className="flex items-center gap-2 mt-2 pt-2 border-t border-zinc-700/50">
            ...
            <p className="text-[8px] font-black uppercase tracking-[0.1em]" style={{ color: tc }}>
              {driver.team}
            </p>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 font-sans pb-24 selection:bg-orange-500/30">
      ...
      <section className="container mx-auto px-6 mb-12">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 bg-gradient-to-br from-zinc-900/50 to-black border border-orange-500/20 rounded-xl p-8">
          <div className="flex items-start gap-6">
            <div className="relative shrink-0">
              <div className="w-20 h-20 rounded-lg bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center shadow-2xl shadow-orange-500/40">
            ...
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-orange-400 mb-2">Next Race</p>
          ...
          <div className="flex items-stretch gap-0 bg-black/60 rounded-lg border border-orange-500/30 overflow-hidden">
            {[{ val: timeLeft.d, label: 'DAYS' }, { val: timeLeft.h, label: 'HRS' }, { val: timeLeft.m, label: 'MIN' }, { val: timeLeft.s, label: 'SEC' }].map((t, i) => (
              <div key={i} className="flex flex-col items-center justify-center px-5 py-3 border-r border-zinc-700/50 last:border-r-0">
                <span className="text-3xl font-black font-mono text-orange-400">{t.val}</span>
